...
class wx_config_settings(models.TransientModel):
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('wx_appid', self.wx_appid)
        self.env['ir.config_parameter'].sudo().set_param('wx_AppSecret', self.wx_AppSecret)
        self.env['ir.config_parameter'].sudo().set_param('wx_token', self.wx_token)
        self.env['ir.config_parameter'].sudo().set_param('wx_channel', self.wx_channel)
...
class wxcorp_config_settings(models.TransientModel):
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('Corp_Id', self.Corp_Id)
        self.env['ir.config_parameter'].sudo().set_param('Corp_Secret', self.Corp_Secret)
        self.env['ir.config_parameter'].sudo().set_param('Corp_Agent', self.Corp_Agent)
        self.env['ir.config_parameter'].sudo().set_param('Corp_Token', self.Corp_Token)
        self.env['ir.config_parameter'].sudo().set_param('Corp_AESKey', self.Corp_AESKey)
        self.env['ir.config_parameter'].sudo().set_param('Corp_Channel', self.Corp_Channel)